...
function openModalSubject(subject) {
    ...
    if ($(".list-hometask-for-days").children().length == 0) {
        $(".right-content-subject").css("display", "none");
        $(".left-content-subject").css({
            "border-right": "none",
            "padding-right": "0px",
            "padding-bottom": "0px",
            "align-items": "center",
        ...
        $(".content-subject").css("display", "block");
    }
}
